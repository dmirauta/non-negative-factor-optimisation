...
class oNMF_W(Factor):
    ...
    def grad_neg_pos(self):
        return        DW(self.decomp.V,
                         self.value,
                         self.decomp.factors['H'].value)
...
class oNMF_H(Factor):
    ...
    def grad_neg_pos(self):
        return        DH(self.decomp.V,
                         self.decomp.factors['W'].value,
                         self.value)
...
class oNMF(Decomp):
    ...
    def reconstruct(self):
        return cNMF_reconstruction(self.factors['W'].value,
                                   self.factors['H'].value )
